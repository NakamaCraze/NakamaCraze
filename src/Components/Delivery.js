...
function Delivery(){
    return(
        <div id="delivery">
             <h1 className=' text-center py-3 bg-yellow section '>ДОСТАВКА</h1>
             <Container fluid className="my-sm-5 py-5">
                <Row>
                    <Col className="text-center">
                        <h1 className="text-yellow px-4 pb-3 font-weight-revert">ДОСТАВКА РАБОТАЕТ ПО АЛМАТЫ</h1>
